...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String enteredVal = "";
        String[] acceptedVals = { "booth", "Booth", "window", "Window",
            "regular", "Regular" };
        ...
        while (true) {
            System.out.println("Please enter the arrival time in military time,"
                + " just numbers (0000): ");
            while (!scanner.hasNextInt()) {
                System.out.println(
                    "Invalid type, please enter a whole number:");
                scanner.nextLine();
            }
